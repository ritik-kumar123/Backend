...
const registerUser = asyncHandler(async(req,res)=>
{
   ...
   console.log(avatarLocalPath ,"avtar");
...
const changeCurrentPassword = asyncHandler(async(req,res)=>
{
    ...
    return res.status(200).json( new ApiResponse(200,{}, "Password Chnaged successsfully"));
})
...
const updateUserAvatar = asyncHandler(async(req,res)=>{
    ...
    if(!avatar.url)
    {
       ...
       const user = await User.findOneAndUpdate(req.user?._id,{$set:{avatar:avatar?.url}},{new:true});
        return res
        .status(200)
...
const updateUserCoverImage = asyncHandler(async(req,res)=>{
    ...
    if(!coverImage.url)
    {
       ...
       const user = await User.findOneAndUpdate(req.user?._id,{$set:{coverImage:coverImage?.url}},{new:true});
    return res
      .status(200)
